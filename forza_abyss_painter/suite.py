...
rule: forza_abyss_painter.suite must NEVER import from forza_abyss_painter.inject, forza_abyss_painter.ac, forza_abyss_painter.shapegen,
forza_abyss_painter.nfs, or forza_abyss_painter.crew — those modules import FROM here, not the other way.
"""
