...
Strict separation: this panel imports from forza_abyss_painter.ac.* only — never from
forza_abyss_painter.inject, forza_abyss_painter.shapegen, or forza_abyss_painter.io.
"""
...
from forza_abyss_painter.ac.car_catalog import CarEntry, list_cars
from forza_abyss_painter.ac.profiles import ACTitleProfile, list_profiles
from forza_abyss_painter.gui.ac_paint_picker import ACPaintPanel
