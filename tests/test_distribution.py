...
def test_normal_distribution_keeps_line_guide_optional():
    ...
    spec = (ROOT / "FD64FH6354221.spec").read_text(encoding="utf-8")
    spec_onedir = (ROOT / "FD64FH6354221_onedir.spec").read_text(encoding="utf-8")
    ...
    assert "!FD64FH6354221.spec" in gitignore
    assert "!FD64FH6354221_onnx.spec" in gitignore
    assert "!FD64FH6354221_onedir.spec" in gitignore
...
def test_onnx_distribution_bundles_line_guide_runtime():
    ...
    spec = (ROOT / "FD64FH6354221_onnx.spec").read_text(encoding="utf-8")
    ...
    assert "FD64FH6354221_onnx.spec" in build_bat
    ...
    assert "FD64FH6354221_onnx" in spec
