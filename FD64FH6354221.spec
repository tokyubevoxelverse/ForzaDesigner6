...
datas = [('fd6\\settings\\profiles', 'fd6\\settings\\profiles'), ('fd6\\inject\\patterns', 'fd6\\inject\\patterns'), ('LICENSE', '.'), ('NOTICE', '.'), ('THIRD_PARTY_NOTICES.md', '.'), ('Song1OpenSource.mp3', '.'), ('Song2OpenSource.mp3', '.'), ('Song3OpenSource.mp3', '.'), ('tools\\fd6_128.png', 'tools'), ('AppIconTransparent.png', '.'), ('BlossomParticle.png', '.'), ('fonts', 'fonts'), ('Pink.png', '.'), ('Yellow.png', '.'), ('Purple.png', '.'), ('Green.png', '.'), ('Blue.png', '.'), ('Orange.png', '.')]
binaries = []
hiddenimports = ['fd6.gui.music', 'fd6.gui.particles', 'fd6.gui.fonts', 'fd6.gui.image_search', 'PySide6.QtWebEngineCore', 'PySide6.QtWebEngineWidgets', 'PySide6.QtWebChannel', 'PySide6.QtWebEngineQuick', 'PySide6.QtPrintSupport', 'fd6.inject.cli', 'fd6.inject.discovery', 'fd6.inject.patterns_io', 'fd6.inject.win_process', 'fd6.inject.fh6_injector', 'fd6.inject.game_profiles', 'fd6.inject.rtti_locator', 'fd6.gui.inject_worker', 'fd6.gui.inject_dialog', 'fd6.gui.brand_banner', 'fd6.gui.themes', 'fd6.shapegen.render', 'PySide6.QtMultimedia', 'PySide6.QtMultimediaWidgets', 'torch', 'cupy']
